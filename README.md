...
<details>
  ...
  <img src='http://cr-skills-chart-widget.azurewebsites.net/api/api?username=cjh-store&padding=30&skills=angular,batchfile,c,C%23,coffeescript,dart,go,html,json,java,javascript,less,mysql,php,pandas,perl,python,reactjs,scss,shell,svelte,swift,typescript,vue'>
  </a>
